...
--
-- Host: localhost:3306
-- Waktu pembuatan: 06 Jun 2025 pada 19.33
...
(12786, 'GANJAR PRANOWO', 'JAWA TENGAH', '123', 'L', '087663656622', NULL);
...
--
DELIMITER $$
CREATE TRIGGER `update Stok` AFTER INSERT ON `pembelian` FOR EACH ROW UPDATE barang
